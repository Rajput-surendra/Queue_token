                  ...
                  Container(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return InkWell(
                            onTap: (){
                              //Get.toNamed(WinnerDetailsScreen,arguments:lotteryModel?.data?.lotteries?[index].gameId );
                            },
                            child: Padding(
...
//   }
  ...
  buyLotteryApi() async {
    ...
    var request = http.Request('POST', Uri.parse('https://developmentalphawizz.com/queue_token/Apicontroller/buyLottery'));
    request.body = json.encode({
      "user_id":userId,
      "game_id":widget.gId,
      "amount":amount,
  ...
  bookLotteryNumberApi(String lottery,status) async {
    ...
    var request = http.Request('POST', Uri.parse('https://developmentalphawizz.com/queue_token/Apicontroller/bookLotteryNumber'));
    request.body = json.encode({
      "game_id":widget.gId,
      "user_id":userId,
